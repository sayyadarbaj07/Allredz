        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 border-b border-red-700 pb-12">
            ...
            <div className="col-span-1 md:col-span-2 lg:col-span-1">
              ...
              <img
                src="https://placehold.co/200x60/8B0000/FFFFFF?text=Allredz+Spices"
          ...
          <div className="pt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-3 items-center">
                ...
                <img
                  src="https://placehold.co/60x32/1a187a/ffffff?text=Visa"
                  alt="Visa"
                  className="rounded-md"
                />
                <img
                  src="https://placehold.co/60x32/eb001b/ffffff?text=Mastercard"
                  alt="Mastercard"
                  className="rounded-md"
                />
              </div>
